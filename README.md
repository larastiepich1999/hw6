...
3. Бонусное задание
 ...
 Я сравнила, как менялась частотность этого слова в Google Ngrams и BNC. И распределение частоты употребления этих слов очень сильно разнятся между BNC и Google Ngrams. В BNC тенденция положительная, а в Google Ngrams отрицательна. Эти данные могут разняться из-за разных текстах в этих корпусах. Google Ngrams - содержит больше художественных тексов, а  BNC фокусируется на научных текстах. 
